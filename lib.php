...
class format_flexsections extends core_courseformat\base {
     ...
     *
     * See {@see core_courseformat\base::course_format_options()} for return array definition.
     *
     * Additionally section format options may have property 'cache' set to true
     * if this option needs to be cached in {@see get_fast_modinfo()}. The 'cache' property
     * is recommended to be set only for fields used in {@see core_courseformat\base::get_section_name()},
     * {@see core_courseformat\base::extend_course_navigation()} and {@see core_courseformat\base::get_view_url()}
     *
