...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext(
        'format_flexsections/maxsectiondepth',
        get_string('maxsectiondepth', 'format_flexsections'),
        get_string('maxsectiondepthdesc', 'format_flexsections'),
        10,
        PARAM_INT,
        7
    ));
    $settings->add(new admin_setting_configcheckbox(
        'format_flexsections/showsection0titledefault',
        get_string('showsection0titledefault', 'format_flexsections'),
        get_string('showsection0titledefaultdesc', 'format_flexsections'),
        0
    ));
    $options = [
    ...
    $settings->add(new admin_setting_configselect(
        'format_flexsections/courseindexdisplay',
        get_string('courseindexdisplay', 'format_flexsections'),
        get_string('courseindexdisplaydesc', 'format_flexsections'),
        0,
        $options
    ));
    $settings->add(new admin_setting_configcheckbox(
        'format_flexsections/accordion',
        get_string('accordion', 'format_flexsections'),
        get_string('accordiondesc', 'format_flexsections'),
        0
    ));
    $settings->add(new admin_setting_configcheckbox(
        'format_flexsections/cmbacklink',
        get_string('cmbacklink', 'format_flexsections'),
        get_string('cmbacklinkdesc', 'format_flexsections'),
        0
    ));
}
