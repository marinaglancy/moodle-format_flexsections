...
$string['section_move_into_feedback'] = 'Course section {$a->name} moved into course section {$a->targetSectionName}.';
$string['section_move_into_feedback_batch'] = 'Selected {$a->count} course sections moved into course section {$a->targetSectionName}.';
