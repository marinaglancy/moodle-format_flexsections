...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=void 0,_exporter=(obj=_exporter)&&obj.__esModule?obj:{default:obj};class _default extends _exporter.default{section(state,sectioninfo){const children=sectioninfo.children,section=super.section(state,sectioninfo);if(section.children=[],children&&children.length)for(let i=0;i<children.length;i++)section.children.push(this.section(state,children[i]));return section}course(state){const course=super.course(state);return course.maxsectiondepth=state.course.maxsectiondepth,course}}return _exports.default=_default,_exports.default}));
